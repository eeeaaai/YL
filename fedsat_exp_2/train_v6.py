...
- ensures initial and final eval points are added consistently
- calls log_upload for all algos
- appends eval_history tuples consistently (t_min, applied_updates, acc, reason)
"""
...
def main():
    ...
    def on_event(t, etype, sid, k_pass):
        ...
        # Safety: ensure synchronous aggregate isn't left pending
    ...
    # Ensure a final eval point (consistent tuple structure)
